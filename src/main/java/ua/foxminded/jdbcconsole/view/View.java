package ua.foxminded.jdbcconsole.view;
...
public class View {
	...
	String regexNameStudent = "[A-z]{1,15}";
	String regexNameGroup = "[a-z]{2}\\-{1}[0-9]{2}";
	String regexNameCourse = "[a-z]{3,16}";
	String regexId = "\\d{1,3}";
		...
		do {
			...
			case "1":// create
				if (table.equals("1")) {// student
					...
					firstName = inputName(regexNameStudent, "first");// !!!!!! возможно переменная
					lastName = inputName(regexNameStudent, "last");// !!!!!! возможно переменная
